						    ...
						    while ($result = $data->fetch_assoc()){
						      ...
						      <tr>
							    ...
							    <td class="center">                                   
									...
									<a class="btn btn-info" href="edit_servis.php?no=<?php echo $result ['no_servis'] ; ?>" title="Edit Data">
										<i class="halflings-icon white edit"></i></a>                                     
										
									<a class="btn btn-success" href="../aksi/proses_teknisi.php?no=<?php echo $result ['no_servis'] ; ?>" title="Ambil Barang">
