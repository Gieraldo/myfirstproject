						    ...
						    while ($result = $data->fetch_assoc()){
						      ...
						      <tr>
							    ...
							    <td class="center">                                        
									...
									<a class="btn btn-danger" href="../aksi/proses_teknisi.php?kd_jasa=<?php echo $result ['kd_jasa'] ; ?>"onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"title="Hapus Data">
